                ...
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="text-center">
                            ...
                            <h2 className="mt-4 text-3xl font-bold text-gray-900 sm:text-4xl xl:text-5xl font-pj">Our happy users say about us</h2>
                        </div>
                                    ...
                                    <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                                        <div className="flex-1">
                                            ...
                                            <blockquote className="flex-1 mt-8">
                                                <p className="text-lg leading-relaxed text-richblue-700 font-pj">“You made it so simple. My new site is so much faster and easier to work with than my old site. I just choose the page, make the change.”</p>
                                            </blockquote>
                                        </div>
